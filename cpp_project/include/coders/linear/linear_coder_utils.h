...
public:
#if MASK_MODE
    static std::vector<int> createXCoordsWithNoDataVectorCA(DecoderBase* decoder, int window_size, int row_index);
    static std::vector<int> createXCoordsWithNoDataVectorPWLH(DecoderBase* decoder, int window_size, int row_index);
