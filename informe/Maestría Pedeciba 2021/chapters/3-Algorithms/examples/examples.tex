...
\newcommand{\makeCaption}[4]{Example: Algorithm \uppercase{#1} with $\maxerror={#2}$ and $\win={#3}$. Step {#4}.}

\newcommand{\makeCaptionIntroPWLH}[3]{Example: checking the valid hull condition. Algorithm \uppercase{#1} with $\maxerror={#2}$. Step~{#3}.}

\newcommand{\makeCaptionIntroCA}[3]{Example: key steps of the coding algorithm. Algorithm \uppercase{#1} with $\maxerror={#2}$. Step~{#3}.}

\newcommand{\makeCaptionIntroSF}[3]{Example: key steps of the coding algorithm. Algorithm \uppercase{#1} with $\maxerror={#2}$. Step~{#3}.}
