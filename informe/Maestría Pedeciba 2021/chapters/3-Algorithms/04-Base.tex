...
\vspace{-5pt}
\Revisor{Algorithm \textit{Base} is a trivial lossless coding algorithm that yields a standard representation of the uncompressed data, which serves as a base ground for comparing the performance of the rest of the algorithms. It encodes every sample independently and using the same number of bits.} 
