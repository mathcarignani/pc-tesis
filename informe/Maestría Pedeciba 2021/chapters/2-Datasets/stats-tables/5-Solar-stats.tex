...
\newcommand{\finTableSolar}[3]{
\toprule[0.1mm]
\end{tabular}
\caption{Number of gaps (total and percentual), and minimum, maximum, median, and standard deviation, of the sample values (in \unitSolar), for each data type of the dataset Solar, for year {#2}. {#3}}
{#1}
\end{center}
\end{table}
}
...
\finTableSolar{\label{datasets:table:solar1}}{2011}{\ignoredGaps}


\vspace{-10pt}
\beginTableSolar
GHI & 0 (0) & 0 & 1,004 & \ \ 9 & 186.0 & 269.7 \\\hline
DNI & 0 (0) & 0 & \ \ \ 958 & \ \ 3 & 178.3 & 272.8 \\\hline
DHI & 0 (0) & 0 & \ \ \ 485 & \ \ 7 & \ \ 72.7 & 100.4 \\\hline
\finTableSolar{\label{datasets:table:solar2}}{2012}{Notice that there are no gaps in the data.}
...
\finTableSolar{\label{datasets:table:solar3}}{2013}{\ignoredGaps}
...
\finTableSolar{\label{datasets:table:solar4}}{2014}{\ignoredGaps}
