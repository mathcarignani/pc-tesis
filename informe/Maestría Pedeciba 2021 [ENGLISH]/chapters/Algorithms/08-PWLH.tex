...
\input{chapters/Algorithms/pseudo/08-PWLH/PWLH-Win-C}
...
Eventually, in the 10th iteration, sample value 2 is considered. For the updated convex hull, which is shown in Figure~\ref{example:pwlh:8}, for the first time the valid hull condition is not satisfied, i.e. \validHull\ in \Line 7 becomes false. Observe that, for each of the four edges in the boundary of the convex hull, there exists a point in the hull such that its distance to the edge line is greater than $2\maxerror$. 
