...
\toprule[0.1mm]
\end{tabular}
\caption{Number of gaps (total and percentual), and minimum, maximum, median, and standard deviation, of the sample values (in \unitSolar), for each data type of the dataset Solar, for year {#2}. The gaps are ignored when calculating the median, mean and standard deviation.}
{#1}
\end{center}
\end{table}
}
