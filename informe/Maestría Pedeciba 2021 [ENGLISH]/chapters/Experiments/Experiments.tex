...
\input{chapters/Experiments/0-Intro}
\input{chapters/Experiments/1-Setting}
\input{chapters/Experiments/2-Comparison}
\input{chapters/Experiments/3-WindowSize}
\input{chapters/Experiments/4-Performance}
\input{chapters/Experiments/4.1-Gzip}
\input{chapters/Experiments/5-Conclusions}
\input{chapters/Experiments/6-Future}
