...
\newcommand{\threefoursingle}[5]{
    ...
    \begin{figure}
    \hspace{-100pt} % trim=left bottom right top
    \includegraphics[clip,trim=0 1.8cm 0 2.5cm,height=19.5cm]{appendices/3-imagesPlots3.4/{#1}}
    \hspace{+5pt}
    \caption{Global window size and compression ratio plots for every algorithm, for the data type ``{#3}" of the dataset {#2}.{#4}}
    {#5}
    \end{figure}
}
