...
\begin{center}
    ...
    \toprule[0.1mm]
    \end{tabular}
    \caption{Relative performance of the global and local window variants of each CAI.\\The results are aggregated by algorithm and according to\\the range to which values taken by RD belong.}
