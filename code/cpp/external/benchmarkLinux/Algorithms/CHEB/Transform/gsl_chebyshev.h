...
// Add ====>
int gsl_cheb_cal(gsl_cheb_series * cs, const double *FuncValue,
                  const double a, const double b);
// Add <====
...
// Add ====>
double gsl_cheb_eval1(const double* dCoeffsArray, int nSize, const double a, const double b, const double x);
// Add <====
