...
class SinglePlot(object):
    ...
    def add_values(self, window, value0, value3):
        ...
        value = self.__plot_value(value0, value3)
    ...
    def plot(self, ax, ylim, error_threshold, extra):
        # scatter plot
        ...
        # horizontal lines
        self.__plot_horizontal_line(ax, 0, 'black')
    ...
    @classmethod
    def __plot_value(cls, value0, value3):
        if value0 == value3:
            return 0
