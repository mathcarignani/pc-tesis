...
class GAMPSExample(ExamplesBase):
    def __init__(self):
        ...
        self.label_orig = 'sample (signal 1)'
        self.label_enco = 'sample (signal 2)'
        self.label_deco = 'sample (signal 3)'
        self.epsilon = 0
    ...
    def gamps2(self, filename, step, index):
        ...
        self.label_orig = 'encoded sample (signal 1)'
        self.label_enco = 'encoded sample (signal 2)'
        self.label_deco = 'encoded sample (signal 3)'
        self.common(filename, step, index)
