...
class CompressCPP:
    ...
    @classmethod
    def execute(cls, exe_str):
        cls.print_exe(exe_str)
    ...
    def code_cpp(cls, args):
        ...
        exe_str += " " + cls.coder_params(args)
        header_bits, column_bits, column_mask_bits = cls.execute(exe_str)
